...
We want to keep this repository free of content generated with Large Language Models (LLMs).
This allows us to ensure that all source code (and auxiliary material such as documentation) of the project is original and appropriately attributed to the original authors, and to feel confident about the applicabilty of the license.

That means: **Please don't contribute any material generated by Large Language Models**, using chatbots, coding agents or similar tools.
This includes, but is not limited to, source code, documentation and commit messages.
